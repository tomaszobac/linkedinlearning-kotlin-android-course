...
val SUB_STATUS = booleanPreferencesKey("sub_status")
...
class ProductRepository(private val context: Context) {
    ...
    val subscriptionStatus: Flow<Boolean> = context.dataStore.data.map { pref ->
        pref[SUB_STATUS] ?: false
    }
    ...
    suspend fun subscribeToNewsletter() {
        context.dataStore.edit { prefs ->
            val currentValue = prefs[SUB_STATUS] ?: false
            if (!currentValue) prefs[SUB_STATUS] = true
        }
    }
